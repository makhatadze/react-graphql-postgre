...
const UsernamePasswordInput_1 = __importDefault(require("./UsernamePasswordInput"));
...
let UserResolver = class UserResolver {
    ...
    me({ req, em }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield em.findOne(User_1.User, {
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg('options', () => UsernamePasswordInput_1.default)),
    __param(1, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
